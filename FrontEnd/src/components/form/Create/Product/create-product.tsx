...
export const CreateProduct = ({ onclose }: any) => {
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <div className="modal-overlay">
        <div className="modal-content">
          ...
          <h3 className="title-add">CREATE PRODUCT</h3>
          <div className="add-info-box">
            ...
            <div className="row">
              <TextField
                ...
                margin="normal"
              />
              <FormControl margin="normal" className="product-gender">
            ...
            <DateTimePicker
              className="product-registration-date"
          ...
          <div className="button-container">
            ...
            <Button variant="contained" className="button-create" onClick={handleCreateProduct}>
              Create
            </Button>
          </div>
        </div>
