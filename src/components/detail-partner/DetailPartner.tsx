import DataTable, {
  DataWarehouse,
} from "../edit-partner/partner-list/DataTable";
import TabButton from "../edit-partner/tab-button/TabButton";
...
const DetailPartner: React.FC<EditPartnerProps> = ({ data, onClose }) => {
